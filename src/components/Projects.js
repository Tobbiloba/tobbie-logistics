    ...
    return (
        <div className="w-[100vw] lg:pt-[100px] pt-[70px]  pb-[10vh] relative  md:bottom-20 flex flex-col rounded-tl-[7.5%]  rounded-tr-[7.5%] lg:px-[8vw]">
            <div className="flex justify-between md:pl-6 lg:mt-6">
                ...
                <div>
                    <button className="py-2 px-5 lg:mt-6 rounded-2xl border border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white">View All</button>
                </div>
            </div>
            <div className='flex lg:flex-row md:flex-row md:flex-wrap flex-col md:px-3 md:justify-center justify-between mt-16 lg:items-normal md:items-normal items-center'>
                ...
                <div className='w-[375px] lg:mt-0 md:mt-0 mt-6 lg:mr-3  md:w-[425px]  cursor-pointer h-[350px] hover:h-[575px] overflow-hidden relative hover:top-8 '>
