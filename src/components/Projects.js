...
const Projects = () => {
    return (
        <div className="w-[100vw] lg:pt-[100px] pt-[70px] pb-[10vh] relative bottom-24 flex flex-col rounded-tl-[7.5%] bg-white rounded-tr-[7.5%] lg:px-[8vw]">
            <div className="flex justify-between md:pl-6">
                <div className='border-2 mb-16 border-white border-b-slate-500 pb-6 '>
                    <p className='text-black lg:text-6xl md:text-4xl  font-bold'>Our Project <span className='text-2xl text-slate-500'>/</span><span className='text-xl font-bold text-slate-500'> Latest Projects</span></p>
            ...
            <div className='flex flex-row md:flex-wrap md:px-3 md:justify-center justify-between mt-16 border border-black'>
                ...
                <div className='w-[375px] md:w-[425px]  cursor-pointer h-[350px] hover:h-[575px] overflow-hidden relative hover:top-8 '>
                ...
                <div className='w-[375px] md:mt-4 md:w-[425px] h-[350px] overflow-hidden cursor-pointer hover:h-[575px] border relative hover:top-8'>
                    {/* <div className='absolute w-[375px] transition ease-in-out delay-150 hover:-translate-y-2  opacity-0 hover:opacity-100 cursor-pointer h-[350px] flex justify-center'>
