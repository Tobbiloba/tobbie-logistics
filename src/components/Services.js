...
const Services = () => {
    return (
        <div className="w-[100vw] lg:pb-[30vh] md:pb-[25vh] pb-[10vh] bg-black lg:rounded-tl-[7.5%] lg:px-[8vw] lg:pt-24 md:pt-24 pt-12 px-[4vw] lg:rounded-tr-[7.5%] md:rounded-tr-[5%] overflow-x-hidden md:rounded-tl-[5%] rounded-tr-[5%] rounded-tl-[5%] flex flex-col">
            ...
            <div className='flex lg:flex-row md:flex-row flex-col-reverse justify-between w-[100vw] overflow-x-hidden'>
                <div className='flex flex-col '>
                    ...
                    <div className='flex flex-row w-[25vw] mt-4 justify-between py-6 border-2 border-black hover:border-b-slate-400 px-6 cursor items-center'>
                        <p className='lg:text-4xl md:backdrop:text-3xl text-white'>Cargo Shipment</p>
                        <div className='border p-3 rounded-full  border-white hover:bg-orange-500 hover:p-5'>
                            <ArrowOutwardIcon style={{ color: 'white' }} className='cursor-pointer' />
                        </div>
                ...
                <div className='lg:w-[] md:w-[] w-[94vw]'>
